...
import { MapId } from '../lib/mockData';
import { cn } from '../lib/utils';
import { Layers, Map as MapIcon, Calendar, Filter, User, Image as ImageIcon, ChevronDown, ChevronRight, Upload } from 'lucide-react';
...
export function Sidebar({ mapId, setMapId, matchId, setMatchId, matches, playerId, setPlayerId, players, playerType, setPlayerType, layers, setLayers, availableMaps = ['AmbroseValley', 'GrandRift', 'Lockdown'], customMapImages = {}, onMapImageUpload, className }: SidebarProps) {
